...
Como as imagens eram de amostragens diferentes, a metodologia utilizada foi de pegar a menor imagem e usar sua altura como referência de tamanho. No caso do nosso experimento, a menor altura era a da imagem com a câmera Sony DSC-H50, na qual as imagens são de dimensões de 3456 × 1944. Abaixo, um exemplo da imagem original do controle com luz branca por uma Canon EOS Rebel SL3 Kit de 24.1 MP.

![controle_D65 original](imagens_referencia/Controle_D65_referencia.JPG)

Em seguida, todas as imagens foram enquadradas e centralizadas com base na sua respectiva altura e, em seguida, foram reduzidas para a dimensão de 1944 x 1944. As imagens com a câmera Sony DSC-H50 apenas foram enquadradas para a dimensão citada. Todo esse processamento é feito no arquivo `processamento.py`
