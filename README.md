...
Como as imagens eram de amostragens diferentes, a metodologia utilizada foi de pegar a menor imagem e usar sua altura como referência de tamanho. No caso do nosso experimento, a menor altura era a da imagem com a câmera Sony DSC-H50, na qual as imagens são de dimensões de 3456 × 1944. Abaixo, um exemplo de uma imagem original com luz branca.

![controle_D65_DSC-H50](controle_original/controle_D65_DSC-H50.jpg)
...
![controle_D65_DSC-H50](controle_resize/branca/controle_D65_DSC-H50.jpg)
...
### 5. Resultados
A partir do arquivo `resultados_metricas.csv`, foram gerados as tabelas de comparação do SSIM e MSE entre a imagem de referência e as demais imagens. Abaixo, o resultado da comparação para a imagem do controle com luz branca. 

![controle_branca](tabelas_resultado/controle_branca.ppg)
[Meu link](https://github.com/guilherme-louro/ImagemVideo/blob/main/tabelas_resultado/controle_branca.png)
